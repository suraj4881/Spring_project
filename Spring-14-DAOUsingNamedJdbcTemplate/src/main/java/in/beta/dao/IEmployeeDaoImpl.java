...
public class IEmployeeDaoImpl implements IEmployeeDao {
	private static final String GET_EMPLOYEE_BY_NAME = "SELECT ENAME FROM EMPLOYEE WHERE EID=:no";
	...
	private static final String INSERT_EMPLOYEE = "INSERT INTO EMPLOYEE(`ename`,`eage`,`eaddress`,`desg`,`salary`)values(:ename,:eage,:eaddress,:desg,:salary)";
