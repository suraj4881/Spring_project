...
import in.beta.controller.EmployeeController;
import in.beta.vo.EmployeeVO;


@SpringBootApplication
public class Spring10ProfileOpertionApplication {
	
	
	static {
		System.out.println("Spring10ProfileOpertionApplication.class file is loading...");
	}
	
	public Spring10ProfileOpertionApplication() {
		System.out.println(
				"Spring10ProfileOpertionApplication:: Zero param constructor...");
	}
	...
	public ComboPooledDataSource createDS() throws Exception {
		System.out.println("Spring10ProfileOpertionApplication.createDS()");
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication
				.run(Spring10ProfileOpertionApplication.class, args);
